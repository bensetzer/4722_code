...
//    GLuint texture;
    ...
    glBindTexture(GL_TEXTURE_CUBE_MAP, fb_texture);
...
//                           GL_TEXTURE_CUBE_MAP_POSITIVE_X ,fb_texture, 0);
...
void render_cube_sides(GLuint frame_buffer, cs4722::view* view2) {
    ...
    glFramebufferTexture2D(GL_DRAW_FRAMEBUFFER, GL_COLOR_ATTACHMENT0,
                           GL_TEXTURE_CUBE_MAP_POSITIVE_Z ,fb_texture, 0);
    ...
    view2->camera_left = glm::cross(view2->camera_up, view2->camera_forward);
    glFramebufferTexture2D(GL_DRAW_FRAMEBUFFER, GL_COLOR_ATTACHMENT0,
                           GL_TEXTURE_CUBE_MAP_NEGATIVE_Z ,fb_texture, 0);
    glClearBufferfv(GL_COLOR, 0, cs4722::x11::navajo_white.as_float().get());
    glClear(GL_DEPTH_BUFFER_BIT);
    glViewport(0, 0, frame_buffer_width, frame_buffer_height);
    scene1_render(view2);
    ...
    // negative x
    view2->camera_forward = glm::vec3(-1,0,0);
    view2->camera_up = glm::vec3(0,-1,0);
    view2->camera_left = glm::cross(view2->camera_up, view2->camera_forward);
    glFramebufferTexture2D(GL_DRAW_FRAMEBUFFER, GL_COLOR_ATTACHMENT0,
                           GL_TEXTURE_CUBE_MAP_NEGATIVE_X ,fb_texture, 0);
    glClearBufferfv(GL_COLOR, 0, cs4722::x11::navajo_white.as_float().get());
    glClear(GL_DEPTH_BUFFER_BIT);
    glViewport(0, 0, frame_buffer_width, frame_buffer_height);
    scene1_render(view2);
    ...
    // positive y
    view2->camera_forward = glm::vec3(0,1,0);
    view2->camera_up = glm::vec3(0,0,1);
    view2->camera_left = glm::cross(view2->camera_up, view2->camera_forward);
    glFramebufferTexture2D(GL_DRAW_FRAMEBUFFER, GL_COLOR_ATTACHMENT0,
                           GL_TEXTURE_CUBE_MAP_POSITIVE_Y ,fb_texture, 0);
    glClearBufferfv(GL_COLOR, 0, cs4722::x11::navajo_white.as_float().get());
    glClear(GL_DEPTH_BUFFER_BIT);
    glViewport(0, 0, frame_buffer_width, frame_buffer_height);
    scene1_render(view2);
    ...
    view2->camera_left = glm::cross(view2->camera_up, view2->camera_forward);
    glFramebufferTexture2D(GL_DRAW_FRAMEBUFFER, GL_COLOR_ATTACHMENT0,
                           GL_TEXTURE_CUBE_MAP_NEGATIVE_Y ,fb_texture, 0);
    glClearBufferfv(GL_COLOR, 0, cs4722::x11::navajo_white.as_float().get());
    glClear(GL_DEPTH_BUFFER_BIT);
    glViewport(0, 0, frame_buffer_width, frame_buffer_height);
    scene1_render(view2);
...
//        scene_setup_for_fb(frame_buffer);
        render_cube_sides(frame_buffer, view2);
