...
namespace cs4722 {
    ...
    /**
      ...
      * @return Pointer to the window created.
      */
    GLFWwindow *setup_window_9_16_9(const char *title) {
        setup_window(title, 0.9, 16.0/9.0);
    }
    ...
    /**
      ...
      * @return Pointer to the window created.
      */
    GLFWwindow *setup_window_9_1_1(const char *title) {
        setup_window(title, 0.9, 1.0);
    }
